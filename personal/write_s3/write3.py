...
COS_SERVICE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/7034cdb9c5cd4906857da0820097248a:543acec2-5392-40d2-9f54-94f323f0f402::" # example: crn:v1:bluemix:public:cloud-object-storage:global:a/xx999cd94a0dda86fd8eff3191349999:9999b05b-x999-4917-xxxx-9d5b326a1111::
...
def main():
    try:
        ...
        upload_large_file("tennisonyu-w251-hw3", "test2.txt", "test2.txt")
